...
@section('title', 'Upload Photo Content')
...
@section('content')
	...
	<div class="panel-body">
        <form action="{{ url('upload_photo/upload2') }}" method="post" enctype="multipart/form-data">
            @csrf
			...
			<div class="form-group"> 
                <label for="source" class="controllabel">File</label> <br/>
