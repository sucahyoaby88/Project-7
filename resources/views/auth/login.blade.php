			...
			<div class="vertical-align-middle">
				<div class="auth-box ">
					<div class="left">
						<div class="content">
							<div class="header">
								<div class="logo text-center"><img src="{{asset('img/klubsepeda.png')}}" alt="Klorofil Logo" width="120px" height="45px"></div>
					...
					<div class="right" style="background-image: url('{{ asset('img/sepeda.jpg')}}');">
